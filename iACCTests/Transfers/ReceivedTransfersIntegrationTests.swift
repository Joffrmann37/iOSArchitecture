...
class ReceivedTransfersIntegrationTests: XCTestCase {
	...
	func test_receivedTransfersList_showsOnlyReceivedTranfers_whenAPIRequestSucceeds() throws {
        ...
        XCTAssertTrue(receivedTransfersList.transferSubtitle(at: 0) == "Received from: any sender on 1/1/01, 12:00 AM" || receivedTransfersList.transferSubtitle(at: 0) == "Received from: any sender on 12/31/01, 7:03 PM", "receivedTransfer subtitle at row 0")
		XCTAssertEqual(receivedTransfersList.transferTitle(at: 1), "$99.99 • any description", "receivedTransfer title at row 1")
		XCTAssertEqual(receivedTransfersList.transferSubtitle(at: 1), "Received from: any sender on 12/31/01, 7:03 PM", "receivedTransfer subtitle at row 1")
	}
